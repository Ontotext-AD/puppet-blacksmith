...
Gem::Specification.new do |s|
  ...
  s.authors = ['Ontotext-AD']
  s.date = Time.now.getutc.strftime '%Y-%m-%d'
  s.summary = 'Tasks to manage Puppet module builds'
  s.description = 'Puppet module tools for development, Puppet Forge management and Nexus deployed modules management'
  s.email = ['support@ontotext.com']
  s.homepage = 'https://github.com/Ontotext-AD/puppet-blacksmith'
  s.require_paths = ['lib']
